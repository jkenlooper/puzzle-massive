...
resource "local_file" "host_inventory" {
  ...
  new_swap=${var.new_swap == "A" ? one(digitalocean_droplet.legacy_puzzle_massive_swap_a[*].ipv4_address) : var.new_swap == "B" ? one(digitalocean_droplet.legacy_puzzle_massive_swap_b[*].ipv4_address) : ""}
  old_swap=${var.old_swap == "A" ? one(digitalocean_droplet.legacy_puzzle_massive_swap_a[*].ipv4_address) : var.old_swap == "B" ? one(digitalocean_droplet.legacy_puzzle_massive_swap_b[*].ipv4_address) : ""}
  ...
  ${var.new_swap == "A" ? one(digitalocean_droplet.legacy_puzzle_massive_swap_a[*].ipv4_address) : var.new_swap == "B" ? one(digitalocean_droplet.legacy_puzzle_massive_swap_b[*].ipv4_address) : ""}

  [legacy_puzzle_massive_old_swap]
  ${var.old_swap == "A" ? one(digitalocean_droplet.legacy_puzzle_massive_swap_a[*].ipv4_address) : var.old_swap == "B" ? one(digitalocean_droplet.legacy_puzzle_massive_swap_b[*].ipv4_address) : ""}
