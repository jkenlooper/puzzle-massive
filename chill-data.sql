...
INSERT INTO Node VALUES(123,'admin_puzzle_page_suggested',NULL,16,1);
INSERT INTO Node VALUES(124,'puzzles',NULL,NULL,39);
INSERT INTO Node VALUES(125,'admin_puzzle_page_suggested_add',NULL,17,1);
INSERT INTO Node VALUES(126,'page',NULL,NULL,1);
INSERT INTO Node VALUES(127,'title','Suggested Puzzle',NULL,NULL);
INSERT INTO Node VALUES(128,'description','Manage suggested puzzle data',NULL,NULL);
INSERT INTO Node VALUES(129,'puzzle',NULL,NULL,40);
INSERT INTO Node VALUES(130,'suggested_puzzle_thank_you_page',NULL,5,1);
INSERT INTO Node VALUES(131,'content','suggested-puzzle-thank-you-content.html',NULL,NULL);
INSERT INTO Node VALUES(132,'description','Thank you page shown after player has suggested an image for a puzzle.',NULL,NULL);
INSERT INTO Node VALUES(133,'title','Thank You',NULL,NULL);
INSERT INTO Node VALUES(134,'internal_attribution_for_id',NULL,18,1);
INSERT INTO Node VALUES(135,'attribution_id',NULL,NULL,41);
INSERT INTO Node VALUES(136,'attribution',NULL,NULL,42);
COMMIT;
PRAGMA foreign_keys=OFF;
BEGIN TRANSACTION;
...
INSERT INTO Node_Node VALUES(123,124);
INSERT INTO Node_Node VALUES(123,113);
INSERT INTO Node_Node VALUES(125,126);
INSERT INTO Node_Node VALUES(126,127);
INSERT INTO Node_Node VALUES(126,128);
INSERT INTO Node_Node VALUES(125,129);
INSERT INTO Node_Node VALUES(130,131);
INSERT INTO Node_Node VALUES(130,132);
INSERT INTO Node_Node VALUES(130,133);
INSERT INTO Node_Node VALUES(134,135);
INSERT INTO Node_Node VALUES(134,136);
COMMIT;
PRAGMA foreign_keys=OFF;
BEGIN TRANSACTION;
CREATE TABLE Query (
...
INSERT INTO "Query" VALUES(39,'_select-admin-puzzles-suggested.sql');
INSERT INTO "Query" VALUES(40,'_select-suggested-puzzle-by-puzzle_id.sql');
INSERT INTO "Query" VALUES(41,'_route_pass_attribution_id.sql');
INSERT INTO "Query" VALUES(42,'_select_attribution_for_id.sql');
COMMIT;
PRAGMA foreign_keys=OFF;
BEGIN TRANSACTION;
CREATE TABLE Route (
...
INSERT INTO Route VALUES(29,'/admin/puzzle/suggested/',123,NULL,'GET');
INSERT INTO Route VALUES(30,'/admin/puzzle/suggested/<puzzle_id>/',125,NULL,'GET');
INSERT INTO Route VALUES(31,'/suggested-puzzle-thank-you/',130,NULL,'GET');
INSERT INTO Route VALUES(32,'/internal/attribution/<int:attribution_id>/',134,NULL,'GET');
COMMIT;
PRAGMA foreign_keys=OFF;
BEGIN TRANSACTION;
...
INSERT INTO Template VALUES(17,'admin-puzzle-suggested-page.html');
INSERT INTO Template VALUES(18,'attribution.html');
COMMIT;
