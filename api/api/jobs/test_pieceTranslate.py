...
class JobTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        (results, col_names) = rowify(cur.execute("select id as puzzle from Puzzle"), cur.description)
    ...
    def test_proximity(self):
        ...
        (results, col_names) = rowify(cur.execute(self.query_puzzle_255), cur.description)
    ...
    def test_join_two_pieces_that_are_both_in_group(self):
        ...
        expectedMsg = ':{piece}:{x}:{y}:270:3:\n:3:679:139::10:\n:2::::10:\n:2:744:139:270:10:'.format(**locals())
        assert len(expectedMsg) == len(msg)
        for l in expectedMsg.split('\n'):
            assert l in msg
    ...
    def test_move_grouped_piece_to_join_immovable(self):
        ...
        expectedMsg = ':{piece}:{x}:{y}:90:8:\n:1:493:283::4:1\n:11:428:283::4:1\n:8::::4:\n:8:363:283:90:4:1'.format(**locals())
        assert len(expectedMsg) == len(msg)
        for l in expectedMsg.split('\n'):
            assert l in msg
