...
customElements.define(tag, class PmPuzzleAlerts extends HTMLElement {
    constructor() {
        super();
        ...
        streamService.subscribe("socket/disconnected", this.onDisconnected.bind(this), this.instanceId);
        streamService.subscribe("socket/reconnecting", this.onReconnecting.bind(this), this.instanceId);
        streamService.subscribe("socket/connected", this.onConnected.bind(this), this.instanceId);
        streamService.subscribe("puzzle/status", this.onPuzzleStatus.bind(this), this.instanceId);
        streamService.subscribe("puzzle/ping/error", this.onPuzzlePingError.bind(this), this.instanceId);
