...
class DivulgerService {
    ...
    _init(puzzleId) {
        if (this.puzzleId === undefined) {
            ...
            this.ws = new WebSocket(`ws://${window.location.host}/divulge/${this.puzzleId}/`);
            this._connect();
        }
    }
    _connect() {
...
_a = socketMax, _b = socketDisconnected, _c = socketConnected, _d = socketReconnecting, _e = pieceUpdate;
