...
customElements.define(tag, class PmPuzzleOriginalActions extends HTMLElement {
    constructor() {
        super();
        this.puzzleId = "";
        this.hasError = false;
    ...
    get data() {
        return {
            ...
            bumpDisabledMessage: !!this.puzzleDetails
                ...
                : "",
            isProcessing: !!this.puzzleDetails && this.status != this.puzzleDetails.status,
            actionHandler: {
    ...
    connectedCallback() {
        userDetailsService.subscribe(this._setPuzzleData.bind(this), this.instanceId);
    }
