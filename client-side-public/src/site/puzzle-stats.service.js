...
class PuzzleStatsService {
    ...
    getActivePlayerCountOnPuzzle(puzzleId) {
        const activePlayerCountService = new FetchService(`/newapi/puzzle-stats/${puzzleId}/active-player-count/`);
    ...
    getPlayerStatsOnPuzzle(puzzleId) {
        ...
        const puzzleStatsService = new FetchService(`/newapi/puzzle-stats/${puzzleId}/`);
