...
class PuzzleImagesService {
    ...
    getPlayerPuzzleImages() {
        const playerPuzzleImagesService = new FetchService("/newapi/player-puzzle-list/");
    ...
    getPuzzleImages(status, _type, piecesMin, piecesMax, page, orderby) {
        ...
        const puzzleImagesService = new FetchService(`/newapi/puzzle-list/?${query.toString()}`);
        const puzzleList = puzzleImagesService
            .get()
    ...
    getGalleryPuzzleImages() {
        const puzzleImagesService = new FetchService(`/newapi/gallery-puzzle-list/`);
        const puzzleList = puzzleImagesService
            .get()
            .then((puzzleListResponse) => {
            return {
