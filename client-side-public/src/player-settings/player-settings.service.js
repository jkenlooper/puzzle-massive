...
class PlayerSettingsService {
    ...
    _init() {
        const storedSetting = window.localStorage.getItem(`${PlayerSettingsService.LocalStorageName}:playPuzzlePieceSound`);
    ...
    set playPuzzlePieceSound(value) {
        window.localStorage.setItem(`${PlayerSettingsService.LocalStorageName}:playPuzzlePieceSound`, value ? "1" : "0");
