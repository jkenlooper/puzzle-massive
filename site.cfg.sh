...
# Set to '' (empty string) to disable all rules
# Or add only some rules:
...
PUZZLE_RULES = {"all"}
# Example of just adding the stacked pieces rules
#PUZZLE_RULES = {"max_stacked_pieces", "stack_pieces"}
